...
extern "C" 
{
	...
	*****************************************************************/
	...
	Input(s):
	    ...
	    channelIndex     -the index(es) of the channel(s) to be turned on, range:[0-32] (in decimal form, 0 for all channels)
	Return: 
	    succeed    -OPT_SUCCEED
	...
	*******************************************************************/
	...
	Input(s):
	    controllerHandle   -the handle of controller
	    channelIndexArray  -an array consists of the indexes of the channels to be turned on, range:[1-32] (in decimal form)
	...
	*******************************************************************/
	...
	Input(s):
	    controllerHandle -the handle of controller
	    channelIndex     -the index(es) of the channel(s) to be turned off, range:[0-32] (in decimal form, 0 for all channels);
	Return:
	    succeed    -OPT_SUCCEED
	...
	*******************************************************************/
	...
	Input(s):
	    controllerHandle  -the handle of controller;
	    channelIndexArray -an array consists of the indexes of the channels to be turned off, range:[1-32] (in decimal form);
		length            -the length of the channel index array
	Return: 
	    succeed    -OPT_SUCCEED;
	    failed     -OPT_ERR_TURNOFFCH_FAILED
	...
	*******************************************************************/
	...
	Input(s):
	    controllerHandle -the handle of controller
	    channelIndex     -the index(es) of the channel(s), range:[0-32] (in decimal form, 0 for all channels)
	...
	*******************************************************************/
	...
	Input(s):
	controllerHandle -the handle of controller
	channelIndex     -the index of the channel, range: [1-32] (in decimal form)
	Output(s): 
	...
	*****************************************************************/
	...
	Input:
		controllerHandle	-the handle of controller
        channelIndex        -he index(es) of the channel, range:[1-32](in decimal form).
	Output:
	...
	*****************************************************************/
	...
	Input:
		controllerHandle		-the handle of controller
		channelIndex			-the index(es) of the channel(s), range:[0-32] (in decimal form);
	...
	*****************************************************************/
	...
	Input:
		controllerHandle		-the handle of controller
		channelIndex			-the index(es) of the channel(s), range:[1-32] (in decimal form);
	Output:
	...
	*****************************************************************/
	...
	Input:
	   ...
	   triggerSource        -the trigger source data,range[1-32](
	...
	*****************************************************************/
	...
	Input:
	   controllerHandle		-the handle of controller
	   moduleIndex			-the index of the channel, range:[1-8] (in decimal form)
	Output:
	    seqCount  		    -the SEQ count,range:[1-64]
	...
	*****************************************************************/
	...
	Input:
	    controllerHandle		-the handle of controller
		channelIndex            -the index of the channel, range:[0-32] (in decimal form)
	...
	*****************************************************************/
	...
	Input:
	    controllerHandle		-the handle of controller
		channelIdx		    	-the index(es) of the channel(s), range:[0-32] (in decimal form),0 for all channels,1-32 for specified channel
	...
	*****************************************************************/
	...
	Input:
	    controllerHandle		-the handle of controller
		channelIdx		    	-the index(es) of the channel(s), range:[1-32] (in decimal form),1-32 for specified channel
    Output:
	    timeUnit                -the time unit,  range:[0-3],0 for 1us,1 for 10us,2 for 1ms,3 for 100ms
	Return: 
		succeed    -OPT_SUCCEED
